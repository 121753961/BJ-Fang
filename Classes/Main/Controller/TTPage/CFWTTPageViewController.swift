...
@objc public protocol CFWTTPageViewControllerDelegate {
    func tt_pageControllerSelectedAt(_ index:Int)
}

open class CFWTTPageViewController: UIViewController {
    
    public var _viewControllers :[UIViewController]!
    
    var currentIndex: Int = 0//current selected index
    
    weak var _delegate:CFWTTPageViewControllerDelegate?
   ...
   public init(controllers:[UIViewController], frame viewFrame:CGRect,delegate:CFWTTPageViewControllerDelegate? = nil) {
...
extension CFWTTPageViewController:UICollectionViewDelegate,UICollectionViewDataSource{
