...
@objc public protocol CFWTTHeadViewDelegate {
    ///TTHeadView选中后方法回调
    func tt_headViewSelectedAt(_ index:Int);
}

public struct CFWTTHeadTextAttribute {
    ///默认字体颜色
...
open class CFWTTHeadView: UIView {
    ///TTHeadView属性
    var textAttribute:CFWTTHeadTextAttribute!
    
    fileprivate var _titles :[String]!
    fileprivate var _currentIndex: Int = 0//current selected
    fileprivate weak var _delegate:CFWTTHeadViewDelegate?
   ...
   public init(frame:CGRect,
               titles:[String],
               delegate:CFWTTHeadViewDelegate? = nil,
               textAttributes:CFWTTHeadTextAttribute = CFWTTHeadTextAttribute())
   {
        super.init(frame:frame)
...
extension CFWTTHeadView:UICollectionViewDelegate,UICollectionViewDataSource {
